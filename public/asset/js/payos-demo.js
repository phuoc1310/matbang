...
// Hàm lấy URL backend Node.js (nếu có). Có thể thay đổi runtime qua localStorage.
// Ví dụ: localStorage.setItem('payos_backend_url', 'http://localhost:3033');
function getBackendUrl() {
    try {
        return localStorage.getItem('payos_backend_url') || 'http://localhost:3033';
    } catch (e) {
